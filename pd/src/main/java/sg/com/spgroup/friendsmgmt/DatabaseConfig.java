...
public class DatabaseConfig
{
    ...
    private static final String[] HIBERNATE_PROP_NAMES = { AvailableSettings.DIALECT,
            AvailableSettings.IMPLICIT_NAMING_STRATEGY, AvailableSettings.HBM2DDL_AUTO,
            AvailableSettings.FORMAT_SQL, AvailableSettings.SHOW_SQL,
            AvailableSettings.GENERATE_STATISTICS, AvailableSettings.USE_QUERY_CACHE,
