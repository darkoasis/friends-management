...
/**
 * Base entity class that uses a UUID as the "id". It provides the id field as
 * well as default hashCode and equals methods based on the id alone.
 */
@MappedSuperclass
...
public abstract class AbstractIdentifiableEntity
{
    ...
    public boolean equals( final Object obj )
    {
        ...
        // This relies on UUID's being globally unique, i.e. not just within a
        // class.
